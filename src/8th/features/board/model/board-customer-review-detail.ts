...
export type BoardCustomerReview = {
  id: string
  rowNum: number
  writer: string
  school: string
...
function transform(json: any): BoardCustomerReviewDetailResponse {
  return makeBoardCustomerReview(json)
}

export type BoardCustomerReviewDetailParams = {
  writeType: string
  id: string
}

export type BoardCustomerReviewDetailResponse = BoardCustomerReview

export async function getBoardCustomerReviewDetail(
  input: BoardCustomerReviewDetailParams,
): Promise<BoardCustomerReviewDetailResponse> {
