...
import { BookDetailInfo } from '@/8th/features/librarydnf/model/book-info'
import {
  useAddFavorite,
  useDeleteFavorite,
} from '@/8th/features/librarydnf/service/library-query'
import {
  useStudent,
...
import PrintVocabularyModalDnf from './PrintVocabularyModalDnf'
...
export default function TodoBookInfoModalDnf({
  imgSrc,
  title,
  bookCode,
  levelRoundId,
