...
export default function AssignmentsListDnf({
  parentPath = SITE_PATH.DODON_FRIENDS.LIBRARY,
}: {
  parentPath?: string
}) {
  return <AssignmentsListDependency parentPath={parentPath} />
}

function AssignmentsListDependency({
  parentPath,
}: {
  parentPath: string
}) {
