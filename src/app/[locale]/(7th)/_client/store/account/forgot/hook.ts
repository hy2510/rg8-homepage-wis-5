...
import { ForgotIdResponse } from '@/7th/_repository/client/account/forgot-id'
import { ForgotIdWithClassAndStudentNameResponse } from '@/7th/_repository/client/account/forgot-id-class-and-student-name'
import { ForgotPasswordResponse } from '@/7th/_repository/client/account/forgot-password'
import { ForgotPasswordConfirmResponse } from '@/7th/_repository/client/account/forgot-password-confirm'
