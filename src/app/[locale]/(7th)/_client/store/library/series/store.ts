import { newSearchLevel } from '@/7th/_repository/client/library/search/search-level'
import { SearchThemeBookResponse } from '@/7th/_repository/client/library/search/search-theme'
...
type State = {
  ...
  payload: SearchThemeBookResponse
}
