...
const DODON_FRIENDS = {
  ...
  LIBRARY: '/8th/dodonfriends/library',
  EB: '/8th/dodonfriends/library/eb',
  EB_LEVEL: '/8th/dodonfriends/library/eb/level',
  EB_SERIES: '/8th/dodonfriends/library/eb/series',
  EB_THEME: '/8th/dodonfriends/library/eb/theme',
  EB_THEME_FIND: '/8th/dodonfriends/library/eb/theme/find',
  EB_MOVIE: '/8th/dodonfriends/library/eb/movie',
  EB_NEWBOOK: '/8th/dodonfriends/library/eb/newbook',
  EB_WORKBOOK: '/8th/dodonfriends/library/eb/workbook',
  EB_SEARCH: '/8th/dodonfriends/library/eb/search',
  EB_SERIES_FIND: '/8th/dodonfriends/library/eb/series/find',
  EB_SCHOOL_SUBJECTS: '/8th/dodonfriends/library/eb/school-subject',
  EB_KINDER: '/8th/dodonfriends/library/kinder',
  EB_PREK: '/8th/dodonfriends/library/kinder/prek',
  EB_DODOABC: '/8th/dodonfriends/library/kinder/dodoabc',
  PB: '/8th/dodonfriends/library/pb',
  PB_LEVEL: '/8th/dodonfriends/library/pb/level',
  PB_SERIES: '/8th/dodonfriends/library/pb/series',
  PB_SERIES_FIND: '/8th/dodonfriends/library/pb/series/find',
  PB_SEARCH: '/8th/dodonfriends/library/pb/search',
  PB_THEME_FIND: '/8th/dodonfriends/library/pb/theme/find',
  PB_THEME: '/8th/dodonfriends/library/pb/theme',
  PB_NEWBOOK: '/8th/dodonfriends/library/pb/newbook',
  ASSIGNMENTS: '/8th/dodonfriends/library/assignments',
  MOVIES: '/8th/dodonfriends/movies',
  DUBBING: '/8th/dodonfriends/dubbing',
  ACTIVITY: '/8th/dodonfriends/activity',
  TODO: '/8th/dodonfriends/activity/todo',
  FAVORITE: '/8th/dodonfriends/activity/favorite',
  TRYAGAIN: '/8th/dodonfriends/activity/tryagain',
  REVIEW: '/8th/dodonfriends/activity/result',
  REVIEW_WRITE: '/8th/dodonfriends/activity/result/write',
  REVIEW_SPEAK: '/8th/dodonfriends/activity/result/speak',
  ACCOUNTINFO: '/8th/dodonfriends/accountinfo',
  ACCOUNTINFO_SETTING: '/8th/dodonfriends/accountinfo/setting',
}
...
const PARAMS_PATH = [
  ...
  `${STUDENT_8TH.EB_LEVEL}/[level]`,
  `${STUDENT_8TH.PB_LEVEL}/[level]`,
  `${STUDENT_8TH.EB_MOVIE}/[level]`,
  `${STUDENT_8TH.EB_WORKBOOK}/[level]`,
  `${STUDENT_8TH.EB_PREK}/[activity]`,
  `${STUDENT_8TH.EB_DODOABC}/[activity]`,
  '/8th/library/[booktype]',
  '/8th/library/[booktype]/level/[level]',
  '/8th/library/[booktype]/search',
  `${DODON_FRIENDS.EB_LEVEL}/[level]`,
  `${DODON_FRIENDS.PB_LEVEL}/[level]`,
  '/8th/dodonfriends/library/[booktype]',
  '/8th/dodonfriends/library/[booktype]/level/[level]',
  '/8th/dodonfriends/library/[booktype]/search',
  '/8th/dodonfriends/movies/[categoryId]',
]
