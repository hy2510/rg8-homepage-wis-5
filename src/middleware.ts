...
export const config = {
  matcher: [
     ...
     */
    '/((?!api|_next/static|_next/image|favicon.ico|assets|faviconL.png|faviconL.svg|faviconM.png|faviconM.svg|faviconS.png|faviconS.svg|manifest.json|robots.txt|public|rg-study-result|src|study|Library|ccc).*)',
  ],
}
