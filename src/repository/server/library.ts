...
async function schoolSubjectPublisher(token: string, input: { grade: string }) {
  const request = makeRequest({
    token,
    path: getPath('school-subject-publisher'),
    option: {
      method: 'get',
      queryString: {
        grade: input.grade,
...
async function schoolSubjectLessonInfo(
  token: string,
  input: { grade: string; publisherCode: string; lesson: string },
) {
  const request = makeRequest({
    token,
    path: getPath('school-subject-lesson-info'),
    option: {
      method: 'get',
      queryString: {
        grade: input.grade,
...
async function schoolSubjectSearchBook(
  token: string,
  input: {
    grade: string
  ...
  const request = makeRequest({
    token,
    path: getPath('school-subject-search'),
    option: {
      method: 'get',
      queryString: {
        grade: input.grade,
...
async function schoolSubjectStudentInfo(token: string) {
  const request = makeRequest({
    token,
    path: getPath('school-subject-student-info'),
    option: {
      method: 'get',
    },
  })
...
async function schoolSubjectStudentInfoUpdate(
  token: string,
  input: { grade: string; publisherCode: string; lesson: string },
) {
  const request = makeRequest({
    token,
    path: getPath('school-subject-student-info-change'),
    option: {
      method: 'post',
      body: {
        grade: input.grade,
...
const Library = {
  ...
  changeFilterPk,
  categoryContinue,
  schoolSubjectPublisher,
  schoolSubjectLessonInfo,
  schoolSubjectSearchBook,
  schoolSubjectStudentInfo,
  schoolSubjectStudentInfoUpdate,
}
